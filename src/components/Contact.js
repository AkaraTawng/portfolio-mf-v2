...
export default function Contact(){
    ...
    <div id="contact-wrapper">
        ...
        <section id="social-icons-section">
            <ul>
                     <Link to="/linkedin" target="_blank" href="https://www.linkedin.com/in/christopher-chamberlain-023507205/">
                    <li id="linkedin">
                    <svg 
                ...
                <a target="_blank" href="https://github.com/AkaraTawng"><li id="github">
                    <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 448 512">
